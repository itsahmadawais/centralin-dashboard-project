                        ...
                        <div className="d-flex justify-content-end">
                            <div className="item align-self-center">
                                <div className="form-check form-switch">
                                    <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Training Mode</label>
